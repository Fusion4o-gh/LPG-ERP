...
import { getSaleBetweenDatesReport, getSaleBetweenDatesReportCsv } from "../../../../server/services/reports/sales-reports.ts";

function csvResponse(csv: string) {
  return new Response(csv, {
    headers: { "Content-Type": "text/csv; charset=utf-8", "Content-Disposition": 'attachment; filename="sale-between-dates.csv"' },
  });
}
