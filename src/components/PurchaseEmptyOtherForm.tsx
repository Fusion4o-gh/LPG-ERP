      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        {printDocumentNo ? (
          <div className="card rounded-lg flex flex-wrap items-center gap-3 px-4 py-3 text-sm">
            ...
            <Link href={kind === "EmptyCylinder" ? purchaseRoutes.empty.print(printDocumentNo) : purchaseRoutes.other.print(printDocumentNo)} className="ml-auto inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 hover:bg-slate-50">
              Open Print View
            </Link>
          </div>
        ) : null}
